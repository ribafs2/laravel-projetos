                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Post</th><th>Comment</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>                    
                                ...
                                @foreach($comments as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->comment }}</td>
                                        <td>
                                            <a href="{{ url('/comments/' . $item->id) }}" title="View Comment"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/comments/' . $item->id . '/edit') }}" title="Edit Comment"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

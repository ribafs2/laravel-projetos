...
class DiariosController extends Controller
{
    ...
    {        
		...
		try {
			...
			if (strpos($e->getMessage(), $existingkey) !== FALSE) {
				return redirect('diarios')->with('duplicate','Este dia já foi cadastrado.');        		
			} else {
				throw $e;
			}
		}        

        return redirect('diarios')->with('insert', 'Adicionado com sucesso!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('diarios')->with('edit', 'Alterado com sucesso!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('diarios')->with('delete', 'Excluído com sucesso!');
    }
}

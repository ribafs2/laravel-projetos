    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
<!--
		todos os métodos devem usar notify, como ...with('notify'..., mas todos os alerts usan danger
        @session('notify')
...
-->
                    ...
                    <div class="card-header">Diarios</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Dia</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>

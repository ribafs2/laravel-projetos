...
if(isset($_POST['enviar'])){
    ...
    try{
       $sql = "INSERT INTO produtos(descricao,unidade,estoque_minimo,estoque_maximo) VALUES (?, ?, ?, ?)";
       $stm = $pdo->prepare($sql)->execute([$descricao, $unidade, $estoque_minimo, $estoque_maximo]);;

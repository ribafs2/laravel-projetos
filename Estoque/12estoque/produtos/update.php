...
$sth = $pdo->prepare("SELECT id, descricao,unidade,estoque_minimo,estoque_maximo from produtos WHERE id = :id");
...
?>
   ...
   <tr><td>Unidade</td><td><input name="unidade" type="text" value="<?=$unidade?>"></td></tr>
...
if(isset($_POST['enviar'])){
    ...
    $sql = "UPDATE produtos SET descricao=:descricao, unidade=:unidade, estoque_minimo=:estoque_minimo,estoque_maximo=:estoque_maximo  WHERE id=:id";
